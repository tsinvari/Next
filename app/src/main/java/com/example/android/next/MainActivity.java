...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_prenda) {
            Intent openPrenda = new Intent(MainActivity.this, Main2Activity.class);
            startActivity(openPrenda);

        } else if (id == R.id.nav_vestuario) {
            Intent openVestuario = new Intent(MainActivity.this, Main3Activity.class);
            startActivity(openVestuario);
